...
void reg_test_library_1( sol::state &lua );
void reg_test_library_2( sol::state &lua );
void reg_test_library_3( sol::state &lua );
void reg_test_library_4( sol::state &lua );
void reg_test_library_5( sol::state &lua );
void reg_test_library_6( sol::state &lua );

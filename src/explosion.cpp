...
static float critter_blast_percentage( Creature *c, float range, float distance )
{
    ...
    switch( c->get_size() ) {
        case( creature_size::creature_size::tiny ):
            return 0.5 * radius_reduction;
        case( creature_size::creature_size::small ):
            return 0.8 * radius_reduction;
        case( creature_size::creature_size::medium ):
            return 1.0 * radius_reduction;
        case( creature_size::creature_size::large ):
            return 1.5 * radius_reduction;
        case( creature_size::creature_size::huge ):

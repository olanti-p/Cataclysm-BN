...
{
    switch( pt ) {
        case JmPieceType::Field:
            return "Field";
        case JmPieceType::NPC:
            return "NPC";
        case JmPieceType::Faction:
            return "Faction";
        case JmPieceType::Sign:
            return "Sign";
        case JmPieceType::Graffiti:
            return "Graffiti";
        case JmPieceType::VendingMachine:
            return "VendingMachine";
        case JmPieceType::Toilet:
            return "Toilet";
        case JmPieceType::GasPump:
            return "GasPump";
        case JmPieceType::Liquid:
            return "Liquid";
        case JmPieceType::Igroup:
            return "Igroup";
        case JmPieceType::Loot:
            return "Loot";
        case JmPieceType::Mgroup:
            return "Mgroup";
        case JmPieceType::Monster:
            return "Monster";
        case JmPieceType::Vehicle:
            return "Vehicle";
        case JmPieceType::Item:
            return "Item";
        case JmPieceType::Trap:
            return "Trap";
        case JmPieceType::Furniture:
            return "Furniture";
        case JmPieceType::Terrain:
            return "Terrain";
        case JmPieceType::TerFurnTransform:
            return "TerFurnTransform";
        case JmPieceType::MakeRubble:
            return "MakeRubble";
        case JmPieceType::Computer:
            return "Computer";
        case JmPieceType::SealedItem:
            return "SealedItem";
        case JmPieceType::Translate:
            return "Translate";
        case JmPieceType::Zone:
            return "Zone";

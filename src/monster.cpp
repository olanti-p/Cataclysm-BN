...
static const std::map<creature_size, translation> size_names {
    { creature_size::creature_size::tiny, to_translation( "size adj", "tiny" ) },
    { creature_size::creature_size::small, to_translation( "size adj", "small" ) },
    { creature_size::creature_size::medium, to_translation( "size adj", "medium" ) },
    { creature_size::creature_size::large, to_translation( "size adj", "large" ) },
    { creature_size::creature_size::huge, to_translation( "size adj", "huge" ) },
};
